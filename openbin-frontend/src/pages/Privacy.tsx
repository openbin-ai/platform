    ...
    <div className="flex h-full flex-col bg-zinc-950 text-zinc-200">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-10">
        ...
        <div className="prose prose-invert prose-sm max-w-none prose-headings:text-zinc-200 prose-a:text-amber-400 text-zinc-300">
          <p>
            OpenBin is bring-your-own-key by design. Your binary, your decompiled tree, your
          ...
          <ul>
            ...
            <li>
              <strong>Project content</strong> — binaries you upload, decompiled output,
              screenshots, annotations, reports, and audit entries. Stored in Postgres + object
              storage owned by the operator of the instance.
            </li>
            <li>
