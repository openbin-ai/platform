              ...
              <div className="mt-4 flex flex-wrap gap-1.5">
                ...
                {report.tags.map((t) => (
                  <Link
                    ...
                    className="rounded-full border border-zinc-700 bg-zinc-800/60 px-2.5 py-0.5 text-[11px] text-zinc-300 hover:border-amber-600 hover:text-amber-200"
                  >
                    #{t}
                  </Link>
                ))}
...
// base URL so the <img> hits api.openbin.ai instead of the current origin.
// Anonymous — no auth header — relies on the backend 302'ing to a presigned
// S3 URL (or streaming bytes on the fs backend).
        ...
        {done ? (
          ...
          <>
            <textarea
              ...
              rows={4}
              maxLength={2000}
              className="w-full rounded border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-600 focus:border-amber-500 focus:outline-none"
            />
            <input
              type="email"
              value={email}
              ...
              maxLength={200}
              className="mt-2 w-full rounded border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-600 focus:border-amber-500 focus:outline-none"
            />
