...
function CommunityPublishModal({
  ...
  // default so the report can link through to the public project view; uncheck
  // to publish the report only and keep the project private.
      ...
      <label className="mt-5 flex cursor-pointer items-start gap-2.5 rounded border border-zinc-800 bg-zinc-950/60 p-3">
        ...
        <span className="text-sm text-zinc-200">
          ...
          <span className="mt-0.5 block text-xs text-zinc-500">
            Adds a “View project” link on your report so readers can open the full project
            view (report &amp; highlights). Uncheck to publish the report only and keep the
            project private.
          </span>
        </span>
      </label>
