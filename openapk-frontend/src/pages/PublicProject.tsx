...
// (projects.public_read_at). Reads /api/public/projects/{id}/** — works
// signed-out (permitAll surface; useApi() only attaches a token when present).
// Shows metadata + report + highlights; the interactive analysis workspace
// stays in the authenticated ProjectView.
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {summary.forkedFromId && (
              <Link
                ...
                className="rounded border border-zinc-700 bg-zinc-800/60 px-1.5 py-0.5 text-[10px] text-zinc-400 hover:text-purple-300"
    ...
    <header className="border-b border-zinc-800 bg-zinc-950">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        <Link to="/" className="text-sm font-semibold tracking-wide text-zinc-100 hover:opacity-80">
          OPENAPK<span className="text-purple-400">.AI</span>
        </Link>
